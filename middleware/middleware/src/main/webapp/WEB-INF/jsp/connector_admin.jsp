...
<header class="text-left">
		<nav class="navbar">
			<div class="d-flex align-items-start">
				<a href="#" >
					<img src="/images/estuate-logo.png" class="navbar-brand">
				</a>    				  
			</div>
				...
				<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
					...
					<div class="form-check">
						<input type="checkbox" class="form-check-input"	id="${con.connectorInfoId}"	name="connectors"	value="${con.connectorInfoId}"> 
							<label class="form-check-label" for="${con.connectorInfoId}">${con.connectorInfoName} <img src="/images/${con.connectorInfoName}.png" alt="${con.connectorInfoName}" class="ml-3" style="width: 26%;"> </label><br>
					</div>
				</c:forEach>
								...
								<c:forEach items="${domainConnectors}" var="domainCon">
									...
									<c:if
										...
										<label class="form-check-label" for="${con.connectorInfoId}">${con.connectorInfoName}
											<img src="/images/${con.connectorInfoName}.png" alt="${con.connectorInfoName}" class="ml-3"
											style="width: 26%;">
										</label>
										</div>
										<%
